...
ρ₀ = []               σ₀ = {}
ρ₁ = [c ↦ ℓ2]         σ₁ = {ℓ0 ↦ 0, ℓ1 ↦ Box{v ↦ ℓ0}}
ρ₂ = [this ↦ ℓ1]      σ₂ = {ℓ0 ↦ 0, ℓ1 ↦ Box{v ↦ ℓ0}, ℓ2 ↦ ℓ1}
                      σ₃ = {ℓ0 ↦ 7, ℓ1 ↦ Box{v ↦ ℓ0}, ℓ2 ↦ ℓ1}
                      σ₄ = {ℓ2 ↦ ℓ1}

                       𝒟₃                                          𝒟₄                                     𝒟₅                                     𝒟₆
  ρ₀, σ₀ ⊢ Box* c = new Box(); ⇒ normal, ρ₁, σ₂    ρ₁, σ₂ ⊢ c->v = 7; ⇒ normal, ρ₁, σ₃    ρ₁, σ₃ ⊢ delete c; ⇒ normal, ρ₁, σ₄    ρ₁, σ₄ ⊢ return 1; ⇒ ret 1, ρ₁, σ₄
  ───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────── (Call)
  ρ₀, σ₀ ⊢ main() ⇒ 1, σ₀
...
𝒟₄
                              ...
                              ρ₁, σ₂ ⊢ c ⇒ ℓ1, σ₂
  ────────────────── (Lit)    ─────────────────────────────────── (LocArrow)
  ρ₁, σ₂ ⊢ 7 ⇒ 7, σ₂          ρ₁, σ₂ ⊢ c->v ⇒ₗ ℓ0, σ₂
  ────────────────────────────────────────────────────────────────────────── (Assign)
  ρ₁, σ₂ ⊢ c->v = 7; ⇒ normal, ρ₁, σ₃

𝒟₅
          𝒟₁                            𝒟₂
  ρ₁, σ₃ ⊢ c ⇒ ℓ1, σ₃    ρ₂, σ₃ ⊢ v = 0; ⇒ normal, ρ₂, σ₂
  ─────────────────────────────────────────────────────── (Delete)
  ρ₁, σ₃ ⊢ delete c; ⇒ normal, ρ₁, σ₄

𝒟₆
  ────────────────── (Lit)
  ρ₁, σ₄ ⊢ 1 ⇒ 1, σ₄
  ────────────────────────────────── (Return)
  ρ₁, σ₄ ⊢ return 1; ⇒ ret 1, ρ₁, σ₄
```
