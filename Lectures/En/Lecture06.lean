...
ρ₀ = []            σ₀ = {}
ρ₁ = [a ↦ ℓ2]      σ₁ = {ℓ0 ↦ 0, ℓ1 ↦ P{x ↦ ℓ0}}
                   σ₂ = {ℓ0 ↦ 0, ℓ1 ↦ P{x ↦ ℓ0}, ℓ2 ↦ ℓ1}
                   σ₃ = {ℓ0 ↦ 3, ℓ1 ↦ P{x ↦ ℓ0}, ℓ2 ↦ ℓ1}
                   σ₄ = {ℓ0 ↦ 3, ℓ1 ↦ P{x ↦ ℓ0}}

                     𝒟₁                                        𝒟₂                                      𝒟₃
  ρ₀, σ₀ ⊢ P* a = new P(); ⇒ normal, ρ₁, σ₂    ρ₁, σ₂ ⊢ a->x = 3; ⇒ normal, ρ₁, σ₃    ρ₁, σ₃ ⊢ return a->x; ⇒ ret 3, ρ₁, σ₃
  ───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────── (Call)
  ρ₀, σ₀ ⊢ main() ⇒ 3, σ₄
...
𝒟₂
                              ...
                              ρ₁, σ₂ ⊢ a ⇒ ℓ1, σ₂
  ────────────────── (Lit)    ─────────────────────────────────── (LocArrow)
  ρ₁, σ₂ ⊢ 3 ⇒ 3, σ₂          ρ₁, σ₂ ⊢ a->x ⇒ₗ ℓ0, σ₂
  ────────────────────────────────────────────────────────────────────────── (Assign)
  ρ₁, σ₂ ⊢ a->x = 3; ⇒ normal, ρ₁, σ₃
