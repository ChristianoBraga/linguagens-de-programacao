...
#eval match parseProgram "class P { public: int x; }; int main() { P* a = new P(); return a->x; }" with
...
ρ₁ = [a ↦ ℓ2]      σ₁ = {ℓ0 ↦ 0, ℓ1 ↦ P{x ↦ ℓ0}}
                   σ₂ = {ℓ0 ↦ 0, ℓ1 ↦ P{x ↦ ℓ0}, ℓ2 ↦ ℓ1}
                     ...
                     𝒟₁                                         𝒟₂
  ρ₀, σ₀ ⊢ P* a = new P(); ⇒ normal, ρ₁, σ₂    ρ₁, σ₂ ⊢ return a->x; ⇒ ret 0, ρ₁, σ₂
  ────────────────────────────────────────────────────────────────────────────────── (Call)
  ρ₀, σ₀ ⊢ main() ⇒ 0, σ₁
